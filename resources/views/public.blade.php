                ...
                <div class="row content">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>
                            ...
                            Yuk cari tahu kenapa kamu harus memilih SMA Negeri 1 Tigapanah, Ayo daftarkan dirimu !!!
                        </p>
        ...
        <section id="more-services" class="more-services">
            <div class="container">
                <div class="section-title" data-aos="fade-up">
                    ...
                    <p>Berikut Ekstrakulikuler SMA N 1 Tigapanah</p>
                </div>
                    ...
                    <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
                        <div class="mapouter">
                            <div class="gmap_canvas"><iframe width="500" height="400" id="gmap_canvas"
                                    src="https://maps.google.com/maps?q=SMA%20N%201%20Tigapanah&t=&z=13&ie=UTF8&iwloc=&output=embed"
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    <div class="copyright">
                        &copy; Copyright <strong>SMA N 1 Tigapanah</strong>
                    </div>
                </div>
                <div class="col-lg-6">
