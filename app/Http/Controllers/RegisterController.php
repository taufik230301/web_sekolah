    ...
    $id = sha1($nomor_pendaftaran.$nidn);
        ...
        try {
            DB::transaction(function () use ($id, $email, $nomor_pendaftaran, $nidn, $nama_lengkap, $tanggal_lahir) {
                ...
                DB::insert("INSERT INTO user_detail(id_user_detail,nomor_pendaftaran,nidn,nama_lengkap,tanggal_lahir,id_status_validasi, id_status_terdaftar) VALUES('$id','$nomor_pendaftaran','$nidn','$nama_lengkap','$tanggal_lahir','1','1')");
            });
                return redirect()
                    ->route('login_web')
                    ->with([
